...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Self-hosted Debian infrastructure running on repurposed hardware using Docker and Cloudflare Tunnel for personal applications and services.",
    year: 2026,
    ...
    architecture: [
      "Intel Core i3-5005U Host Node",
      "Debian 12 Headless OS VM",
      "Docker Container Engine",
      "Cloudflared Ingress Tunnel",
      "Cloudflare DNS Routing Node",
    ],
    featured: true,
