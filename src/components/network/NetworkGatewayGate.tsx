        ...
        <header className="absolute top-0 inset-x-0 z-30 flex items-center justify-between p-3 sm:p-6 pointer-events-none gap-2">
          ...
          <div className="pointer-events-auto flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4.5 py-1.5 sm:py-2.5 rounded-full border border-zinc-200 dark:border-zinc-800 bg-background/90 backdrop-blur-md text-[11px] sm:text-sm font-mono font-bold text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all duration-150 cursor-pointer shadow-sm"
              title="Switch Language (EN / ID)"
              aria-label="Switch Language"
            >
              <Languages className="size-3.5 sm:size-4.5 text-foreground" />
            ...
            <button
              onClick={toggleTheme}
              className="p-2 sm:p-3 rounded-full border border-zinc-200 dark:border-zinc-800 bg-background/90 backdrop-blur-md text-foreground hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all duration-150 cursor-pointer shadow-sm"
