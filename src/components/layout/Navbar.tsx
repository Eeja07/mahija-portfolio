  ...
  return (
    <nav
      ...
      className={cn(
        ...
        scrolled
          ? "border-b border-zinc-200 dark:border-zinc-800 bg-background"
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="font-sans font-semibold tracking-tight text-lg text-foreground hover:text-zinc-500 dark:hover:text-zinc-400 transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
        >
          Mahija
        </Link>
            ...
            {navigationLinks.map((link) => (
              <li key={link.name}>
                <a
                  ...
                  className="text-sm font-medium text-zinc-500 dark:text-zinc-400 hover:text-foreground transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring rounded-sm px-1 py-0.5"
                >
                  {link.name}
                </a>
              </li>
          ...
          <div className="flex items-center gap-3">
            {mounted && (
              <Button
                ...
                className="text-zinc-500 dark:text-zinc-400 hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
              >
                {theme === "dark" ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900 shadow-md">
                {resumeVariants.map((variant) => (
                  ...
                  >
                    ...
                    <Badge variant="outline" className="ml-auto font-mono text-[9px] px-1.5 py-0 select-none border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-900">
                      {variant.language}
                    </Badge>
                  </DropdownMenuItem>
                ))}
                ...
                <nav aria-label="Mobile Navigation Menu" className="flex flex-col gap-4">
                  {navigationLinks.map((link) => (
                    <a
                      ...
                      href={link.href}
                      onClick={(e) => handleLinkClick(e, link.href)}
                      className="text-base font-medium text-zinc-500 dark:text-zinc-400 hover:text-foreground transition-colors duration-150 py-1.5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
                    >
                      {link.name}
                    </a>
                  ))}
              ...
              <div className="flex flex-col gap-3 mt-auto">
                ...
                <a
                  ...
                  className={cn(
                    ...
                    "w-full border border-zinc-200 dark:border-zinc-800 text-foreground hover:bg-zinc-200 dark:hover:bg-zinc-800 font-medium justify-center text-center flex items-center gap-2"
                  )}
                >
                  <Download className="size-4" />
