...
const contactChannels: ContactChannel[] = [
  ...
  {
    name: "Instagram",
    handle: "instagram.com/mahijaibad",
    href: "https://www.instagram.com/mahijaibad",
    icon: <InstagramIcon className="size-4" />,
    protocol: "Instagram Feed",
  },
  {
    name: "Twitter / X",
    handle: "x.com/eejasukareply",
    href: "https://x.com/eejasukareply",
    icon: <TwitterIcon className="size-4" />,
    protocol: "X / Twitter Stream",
  },
  {
    name: "Facebook",
    handle: "facebook.com/mahijaibad",
    href: "https://www.facebook.com/mahijaibad",
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Header */}
        <div className="flex flex-col gap-3 mb-16 text-center md:text-left items-center md:items-start max-w-2xl mx-auto md:mx-0">
          <h2 
            id="contact-heading"
