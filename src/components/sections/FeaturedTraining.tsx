              ...
              >
                <div className="flex-1 flex flex-col gap-3 min-h-0">
                  <div className="flex items-center justify-between font-mono text-xs text-zinc-500 dark:text-zinc-400 h-5 shrink-0">
                    ...
                    <span className="shrink-0">{tr.period}</span>
                  </div>

                  <div className="min-h-[3.25rem] max-h-[3.25rem] flex flex-col justify-start overflow-hidden">
                    <h3 className="font-sans text-base sm:text-lg font-bold text-foreground tracking-tight leading-snug line-clamp-2">
                      {tr.title}
                    </h3>
                  </div>
                  ...
                  <div className="min-h-[1.75rem] max-h-[1.75rem]" aria-hidden="true" />
                </div>
