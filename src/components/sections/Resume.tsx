            ...
            <NetworkSubsystemNode className="p-6 sm:p-7 text-left border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/50 rounded-2xl">
              <div className="flex items-center gap-2.5 mb-5">
                ...
                <h3 className="font-sans text-lg font-bold tracking-tight text-foreground">
                  {language === "id" ? "Pendidikan (Education)" : "Education"}
                </h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-4 sm:p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-background/80 flex flex-col justify-between gap-3 shadow-2xs">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex items-center justify-between font-mono text-[10px] text-zinc-500">
                      <span className="uppercase text-zinc-700 dark:text-zinc-300 font-semibold">Surabaya</span>
                      <span>July 2022 – August 2026</span>
                    </div>
                    <h4 className="font-sans text-base font-bold text-foreground leading-snug">
                      Sepuluh Nopember Institute of Technology — Surabaya
                    </h4>
                    <p className="font-sans text-xs text-zinc-600 dark:text-zinc-400 italic">
                      Bachelor of Computer Engineering
                    </p>
                    <div className="mt-1 inline-flex items-center">
                      <span className="font-mono text-xs font-semibold px-2 py-0.5 rounded border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900 text-foreground">
                        GPA: 3.32/4.00
                      </span>
                    </div>
                  </div>
                ...
                <div className="p-4 sm:p-5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-background/80 flex flex-col justify-between gap-3 shadow-2xs">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex items-center justify-between font-mono text-[10px] text-zinc-500">
                      <span className="uppercase text-zinc-700 dark:text-zinc-300 font-semibold">Jakarta</span>
                      <span>July 2019 – May 2022</span>
                    </div>
                    <h4 className="font-sans text-base font-bold text-foreground leading-snug">
                      SMAN 4 Jakarta — Jakarta
                    </h4>
                    <p className="font-sans text-xs text-zinc-600 dark:text-zinc-400 italic">
                      Science Major
                    </p>
